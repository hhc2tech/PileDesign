...
public class QsCoyleandCastellosMethod extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myView=inflater.inflate(R.layout.qs_coyle_and_castellos_method,container,false);
        ...
        getActivity().setTitle("Coyle and Castello's Method for Qs");
        ...
        btnCompute.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    //Calculation of f
                    f=k*(0.5*length*gama)*Math.tan(delta*Math.PI/180);
